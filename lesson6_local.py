# L6 Automate event planning
# from https://learn.deeplearning.ai/courses/multi-ai-agent-systems-with-crewai/lesson/15/mutli-agent-collaboration-for-financial-analysis-(code)
