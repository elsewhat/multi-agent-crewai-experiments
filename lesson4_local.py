...
# from https://learn.deeplearning.ai/courses/multi-ai-agent-systems-with-crewai/lesson/9/tools-for-a-customer-outreach-campaign-(code)
...
from crewai_tools import DirectoryReadTool, \
                         FileReadTool, WebsiteSearchTool
